...
#	$sth1->execute() or die $sth1->errstr."\n";
	my @synonyms = ("annealed", "arthritic", "benumbed", "brittle", "buckram", "cemented", "chilled", "congealed", "contracted", "creaky", "firm", "fixed", "frozen", "graceless", "hardened", "immalleable", "impliable", "incompliant", "indurate", "inelastic", "jelled", "mechanical", "numbed", "ossified", "petrified", "refractory", "resistant", "rheumatic", "rigid", "set", "solid", "solidified", "starched","starchy", "stark", "steely", "stiff as a board", "stony", "taut", "tense", "thick", "thickened", "tight", "unbending", "unflexible", "ungraceful", "unsupple", "unyielding", "wooden","arduous", "exacting", "fatiguing", "formidable", "hard", "laborious", "tough", "trying", "uphill", "austere", "brisk", "cruel", "drastic", "exact", "excessive", "exorbitant", "extravagant", "great", "hard", "harsh", "heavy", "immoderate", "inexorable", "inordinate", "oppressive", "pitiless", "potent", "powerful", "rigorous", "sharp", "steep", "strict", "stringent", "strong", "towering", "unconscionable", "undue", "vigorous");
	my %siblings = ();
